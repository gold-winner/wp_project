<?php
$upload_url = 'https://aktier.se/wp-content/themes/divi-child/uploads/';
...
function insert_mock_data_into_milistream_table()
{
    ...
    $mock_data = array(
        array(
            ...
            'image_url' => $upload_url . 'mock-images/image1.png',
        ),
        array(
            'title' => 'Geopolitik',
            'content' => 'KONSUMENTVERKET STOPPAR CYKELHJÄLMAR',
            'image_url' => $upload_url . 'mock-images/image2.png',
        ),
        array(
            'title' => 'Geopolitik',
            'content' => 'KONSUMENTVERKET STOPPAR CYKELHJÄLMAR',
            'image_url' => $upload_url . 'mock-images/image3.png',
        ),
        array(
            'title' => 'Geopolitik',
            'content' => 'KONSUMENTVERKET STOPPAR CYKELHJÄLMAR',
            'image_url' => $upload_url . 'mock-images/image4.png',
        ),
        array(
            'title' => 'Geopolitik',
            'content' => 'KONSUMENTVERKET STOPPAR CYKELHJÄLMAR',
            'image_url' => $upload_url . 'mock-images/image5.png',
        ),
        array(
            'title' => 'Geopolitik',
            'content' => 'KONSUMENTVERKET STOPPAR CYKELHJÄLMAR',
            'image_url' => $upload_url . 'mock-images/image6.png',
        ),
        array(
            'title' => 'Geopolitik',
            'content' => 'KONSUMENTVERKET STOPPAR CYKELHJÄLMAR',
            'image_url' => $upload_url . 'mock-images/image7.png',
        ),
    );
...
function discords_shortcode()
{
    ...
    foreach ($results as $result) {
        ...
        $output .= $result->img_src ? '<div class="discord"><div class="discord-col-l"><div class="discord-image"><a href="' . esc_url($result->url) . '"><img src="' . $result->img_src . '" alt="' . $result->name . '" class="" width="1080" height="675"></a></div>'
            : '<div class="discord"><div class="discord-col-l"><div class="discord-image"><a href="' . esc_url($result->url) . '"><img src="'. $upload_url .'question-icon.jpg" alt="' . $result->name . '" class="" width="1080" height="675"></a></div>';
...
?>
    <div class="discord-header">
        ...
        <div class="discord-sp">
            ...
            <div class="search-img"><img src="<?php echo esc_url( $upload_url ) . 'search.png'; ?>" /></div>
...
?>
    <div class="stocks-row">
        <div class="stocks-col-left">
            <div class="stocks-title">TOPPLISTA ÖVER SVENSKA AKTIER</div>
        ...
        <div class="stocks-col-right">
            <div class="stocks-rising-img">
                <img src="https://aktier.se/wp-content/themes/divi-child/uploads/rising.png" />
            </div>
            <div class="search" method="post" action="">
                <div class="search-img"><img src="https://aktier.se/wp-content/themes/divi-child/uploads/search.png" /></div>
...
?>
    <div class="stocks-row" style="margin-top: 64px;">
        ...
        <div class="stocks-col-right">
            <div class="stocks-rising-img">
                <img src="https://aktier.se/wp-content/themes/divi-child/uploads/down.png" />
            </div>
            <div class="search" method="post" action="">
                <div class="search-img"><img src="https://aktier.se/wp-content/themes/divi-child/uploads/search.png" /></div>
        ...
        jQuery(document).ready(function($) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (stock.diff1d > 0)
                        $('#stock-status-img').append('<img src="https://aktier.se/wp-content/themes/divi-child/uploads/rising.png"/>');
                    else
                        $('#stock-status-img').append('<img src="https://aktier.se/wp-content/themes/divi-child/uploads/down.png"/>');
